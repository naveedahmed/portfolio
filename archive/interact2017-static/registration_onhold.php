...
<div class="right-col">
	...
	<article>
		...
		<div class="info red">
			<p><span class="bold">Registrations are on hold</span></p>

<p>The registrations are temporarily on hold as we are currently upgrading our systems. 
</p>
<p>This will take a while and the registrations will open again on July 17, 2017. Follow us on <a href="https://www.facebook.com/interact2017" target="_blank">Facebook</a> and <a href="https://twitter.com/interact2017" target="_blank">Twitter</a> for updates. 
</p>		</div>
		<h3>Delegate Fees</h3>
		<section>
		    ...
		    &nbsp; Discounted Pricing for Developing Countries (<span class="bold"><?php echo $developingTicketsLeft ?> Left</span> | <a href="#" data-toggle="modal" data-target="#country-details" class="">Details</a>)</label>
          ...
          <span aria-hidden="true">&times;</span>
						...
						<div class="modal-body">
							<p>To encourage participants from developing countries, 100 participants from developing countries will be given an additional discount of <span class="bold"><?php coursePricing(8000);?>
<!--
...
-->
			...
			<?php echo '<div class="info yellow">Status: Only <strong>' .  $developingTicketsLeft . '</strong> of 100 Passes Left</div> '; ?>
			...
			<div class="price-table">
				<div class="price-slab">
					...
					<div class="right">
						<div class="price-cube"><span class="price">
							...
							<a href="#" class="register not-open closed">CLOSED</a>
						</div>
					</div>
				</div>
				<div class="price-slab">
				...
				<div class="price-slab">
					<div class="left">
						...
						<p class="date">Opens July 17. Closes on September 1, 2017</p>
					</div>
					<div class="right">
						<div class="price-cube"><span class="price">
							<span class="inr normal"><span class="price-symbol">&#8377;</span>
...
<div class="pricing-controls">
	...
	<div class="price-table">
		...
		<section>
			As the <a href="https://www.interaction-design.org/" target="_blank">Interaction Design Foundation</a> is one of our educational partners, all the registered delegates get a 3-month of free membership on their website. The details will be emailed after purchasing the tickets.
		</section>
